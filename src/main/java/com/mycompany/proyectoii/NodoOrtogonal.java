...
public class NodoOrtogonal {
    ...
    private Vehiculo vehiculo; // Declara una variable privada vehiculo de tipo Vehiculo
    ...
    public NodoOrtogonal(Vehiculo vehiculo, int x , int y) { // Constructor de la clase NodoOrtogonal con parámetros
        this.vehiculo = vehiculo; // Inicializa la variable vehiculo con el parámetro vehiculo
    ...
    public Vehiculo getVehiculo() { // Método para obtener el vehículo asociado al nodo
        return vehiculo; // Retorna el vehículo asociado al nodo
    }

    public void setVehiculo(Vehiculo vehiculo) { // Método para establecer el vehículo asociado al nodo
        this.vehiculo = vehiculo; // Asigna el vehículo con el parámetro vehiculo
    }
