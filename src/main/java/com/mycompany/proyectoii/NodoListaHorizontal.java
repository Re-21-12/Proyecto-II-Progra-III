...
public class NodoListaHorizontal {
    ...
    public NodoListaHorizontal() { // Constructor de la clase NodoListaHorizontal
        this.cabeza = this.cola = null; // Inicializa cabeza y cola como nulos
    }

    public void insertarEnHorizontal(NodoOrtogonal nodoHorizontal) { // Método para insertar un nodo en la lista horizontal
